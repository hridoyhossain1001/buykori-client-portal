import { ChevronRight, PackageCheck, ShieldCheck, ShoppingBag } from 'lucide-react';
...
export function ActionCenter({ pendingOrderCount, openSuggestions, optScore, setActivePage }: ActionCenterProps) {
  return (
