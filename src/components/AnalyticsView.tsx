...
export function AnalyticsView({
  ...
  const isUnknownArea = (label: string) => /unknown|not set|n\/a|unavailable/i.test(String(label || ''));
  ...
  return (
    <div id="analytics-root" ref={analyticsRootRef} className="mx-auto max-w-6xl scroll-mt-20 space-y-4 md:scroll-mt-24 md:space-y-6">
      ...
      <div id="analytics-audience-legacy" aria-hidden="true" className="hidden">
