    ...
    <section className="rounded-2xl border border-indigo-100 bg-gradient-to-r from-indigo-50 via-white to-cyan-50 px-5 py-3 shadow-sm">
      <div className="mb-2 flex flex-wrap items-start justify-between gap-2">
        ...
        <div className="flex gap-2">
          ...
          <button type="button" onClick={download} disabled={!report} className="inline-flex items-center gap-2 rounded-lg bg-indigo-600 px-3 py-1.5 text-xs font-semibold text-white hover:bg-indigo-700 disabled:opacity-50">
